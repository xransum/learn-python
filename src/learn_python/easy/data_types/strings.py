...
word[5] == 'n'  # Fifth character.
word[-1] == 'n'  # Last character.
word[-2] == 'o'  # Second-last character.
word[-6] == 'P'  # Sixth from the end or zeroth from the beginning.

isinstance(word[0], str)
...
try:
    ...
    print("Expected error when index is outside string size")
    print("-"*15)
    print(err)
    print("-"*15)
...
try:
    ...
    print("Expected error when assigning new value to index")
    print("-"*15)
    print(err)
    print("-"*15)
...
string_with_whitespaces.strip() == "Hello, World!"

# The len() method returns the length of a string.
len(hello_world_string) == 13

# The lower() method returns the string in lower case.
hello_world_string.lower() == 'hello, world!'

# The upper() method returns the string in upper case.
hello_world_string.upper() == 'HELLO, WORLD!'

# The replace() method replaces a string with another string.
hello_world_string.replace('H', 'J') == 'Jello, World!'

# The split() method splits the string into substrings if it finds instances of the separator.
hello_world_string.split(',') == ['Hello', ' World!']
...
'I like bananas'.replace('bananas', 'apples') == 'I like apples'
...
repr(greeting) == "'Hello, world.'"
str(1/7) == '0.14285714285714285'

# The argument to repr() may be any Python object:
repr((first_num, second_num, ('spam', 'eggs'))) == "(32.5, 40000, ('spam', 'eggs'))"
...
pi_value = 3.14159
f'The value of pi is {pi_value:.3f}.' == 'The value of pi is 3.142.'
...
'We are {} who say "{}!"'.format('knights', 'Ni') == 'We are knights who say "Ni!"'
...
formatted_string == 'This spam is absolutely horrible.'
...
formatted_string == 'The story of Bill, Manfred, and Georg.'
...
formatted_string == 'Jack: 4098; Sjoerd: 4127; Dcab: 8637678'
